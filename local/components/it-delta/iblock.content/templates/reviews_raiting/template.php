...
<section id="reviews__form" class="reviews__form">
    ...
    <p class="text text-js">Вы смотрите отзывы о всех компаниях в городе <span><?=$currentCity["NAME"]?></span></p>
    <!-- form--top end-->
    ...
    <? foreach($arResult["ITEMS"] as $itemName => $itemCategory): ?>
        ...
        <ul class="reviews__items">
            <? foreach($itemCategory as $item): ?>
                <li class="reviews__item <?=$item["PROPERTIES"]["R_SOURCE"]["VALUE"] == "Vincko" ? "" : "not-vinco__raiting"?>">
                        ...
                        <div class="reviews__item__head">
                            <div class="reviews__item__head--left">
                                ...
                                <div class="person__items">
                                    ...
                                    <span class="town"><?=$currentCity["NAME"]?></span>
                            ...
                            <div class="reviews__item__head--right">
                                <? if($item["PROPERTIES"]["R_SOURCE"]["VALUE"] == "Vincko"):?>
                                    ...
                                    <div class="raiting__content">
                                        <ul class="raiting__vincko">
                                            ...
                                            <li><span class="icon">
                                                ...
                                                </span><span class="text"><?=$item["PROPERTIES"]["R_RATING_SPASENIE"]["VALUE"]?></span>
                                            </li>
                                            <li><span class="icon">
                                                ...
                                                </span><span class="text"><?=$item["PROPERTIES"]["R_RATING_DOGOVOR"]["VALUE"]?></span>
                                            </li>
                                            <li><span class="icon">
                                                ...
                                                </span><span class="text"><?=$item["PROPERTIES"]["R_RATING_FINANCE"]["VALUE"]?></span>
                                            </li>
                                        </ul>
                                    </div>
                                <? else: ?>
                                    ...
                                    <div class="raiting__content">
                                        ...
                                        <span class="icon social">
                                            <svg width="46" height="14" viewBox="0 0 46 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5.60798 1.62443H4.72037C3.09182 1.62443 2.23658 2.4891 2.23658 3.76752C2.23658 5.21931 2.82878 5.89385 4.04554 6.75779L5.04883 7.46657L2.1567 12.0121H0L2.59878 7.95026C1.10176 6.82699 0.263046 5.73797 0.263046 3.88844C0.263046 1.57271 1.79036 0 4.70384 0H7.59597V12.0121H5.60798V1.62443Z" fill="#FC3F1D"></path>
                                                <path d="M23.7321 3.31873H18.025V4.06174C18.025 6.18734 17.8935 8.93576 17.2028 10.3876H16.5955V13.9999H18.4051V12.012H22.7929V13.9999H24.6039V10.3876H23.7321V3.31873ZM21.7751 10.3846H19.0118C19.5544 9.07344 19.7004 6.70308 19.7004 5.19957V4.94316H21.7731L21.7751 10.3846Z" fill="black"></path>
                                                <path d="M13.816 6.75772H11.2013V3.31873H9.24365V12.012H11.2013V8.38288H13.816V12.012H15.773V3.31873H13.816V6.75772Z" fill="black"></path>
                                                <path d="M44.1077 4.77053C44.8652 4.77053 45.6047 5.04661 45.9993 5.30594V3.55767C45.5861 3.31583 44.8645 3.14246 43.8942 3.14246C41.3946 3.14246 40.0952 5.02695 40.0952 7.6712C40.0952 10.5748 41.3616 12.1817 43.9762 12.1817C44.881 12.1817 45.5221 12.0091 45.9993 11.6463V9.97091C45.5062 10.3351 44.914 10.5588 44.0919 10.5588C42.6933 10.5588 42.1183 9.41802 42.1183 7.62094C42.1183 5.73645 42.8255 4.76908 44.1077 4.76908" fill="black"></path>
                                                <path d="M39.8331 3.31799H37.8595L35.0962 7.32809V3.31799H33.1392V12.012H35.0962V7.7433L37.9911 12.012H40.2111L37.0697 7.32809L39.8331 3.31799Z" fill="black"></path>
                                                <path d="M28.6007 3.14537C26.2161 3.14537 25.0813 5.0641 25.0813 7.69087C25.0813 10.7161 26.4957 12.1847 28.996 12.1847C30.2458 12.1847 31.1665 11.8394 31.7421 11.4242V9.74873C31.1334 10.1807 30.1143 10.5609 29.1599 10.5609C27.7297 10.5609 27.1864 9.85217 27.1044 8.40038H31.8241V7.30771C31.8241 4.2832 30.5578 3.14246 28.6007 3.14246V3.14537ZM29.8347 6.87574H27.1044C27.154 5.49169 27.6305 4.76762 28.5684 4.76762C29.5386 4.76762 29.8347 5.61407 29.8347 6.7031V6.87574Z" fill="black"></path>
                                            </svg>
                                        </span>
                                    </div>
                                <? endif ?>
                        ...
                        <div class="reviews__item-right--top">
                            <div class="raiting">
                                <div class="raiting__position">
                                    ...
                                    <span class="raiting__satr-number"><?=$item["PROPERTIES"]["R_RATING_SUM"]["VALUE"]?></span>
                                </div>
                                <p><a href="">vincko:</a></p>
                            </div>
                            <div class="raiting__about">
                                <span class="raiting__about-name"><?=$itemName?></span>
