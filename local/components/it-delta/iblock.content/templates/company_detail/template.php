        ...
        <div class="company-info-card__page-column">
                                            ...
                                            <? if (count($arResult['REVIEWS']) > 0): ?>
                                                <div class="info-block-one__left">
                                                    ...
                                                    <div class="info-block-one__left_icon">
                                                        <img src="/upload/rating/info-block-one__left_icon.svg"
                                                             alt="img">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="info-block-two">
                                            <? if ($arResult['STATUS_COMPANY']['ID'] == 1497): ?>
                                                ...
                                                <a class="contract-link<?= $arResult['PROPERTIES']['HONEST_CONTRACT']['VALUE_XML_ID'] == 'Y' ? '' : ' t-c-gray' ?>" <?= $arResult['PROPERTIES']['HONEST_CONTRACT']['VALUE_XML_ID'] == 'Y' ? 'target=\'_blank\' href=\'' . $arResult['PROPERTIES']['HONEST_CONTRACT']['SRC'] . '\'' : ''; ?>>vincko:
                                                    Честный договор</a>
                                                <a class="contract-link<?= empty($arResult['PROPERTIES']['CONTRACT']) ? ' t-c-gray' : '' ?>" <?= empty($arResult['PROPERTIES']['CONTRACT']['VALUE']) ? '' : 'href=\'' . $arResult['PROPERTIES']['CONTRACT']['VALUE'] . '\' target=\'_blank\'' ?>>Договор
                                                    охранной компании</a>
            ...
            <div class="company-info-card__content-container block">
                ...
                <? if ($arResult['STATUS_COMPANY']['ID'] == 1498 || $arResult['STATUS_COMPANY']['ID'] == 1497): ?>
                    ...
                    <div class="company-info-card__content-container block__tab block__tab--flat checked">
                        ...
                        <div class="company-info-card__content-container-right">
                            <div class="company-info-card__content-container block__title">Решение индивидуальных задач
                            </div>
            ...
            <div class="reviews__item">
                <div class="slick-slider-reviews">
                    <? $i = 0;
                    foreach ($arResult['REVIEWS'] as $review): if ($i++ > 8) break; ?>
            ...
            <div class="solutions-card card-two">
                ...
                <div class="solutions-card__substrate">
                    ...
                    <div class="solutions-card__center">
                        <div class="h2">
                            Вы можете заказать услуги этой компании в рамках <span class="blue">Готового решения</span>
                        </div>
                        <div class="solutions-card__contract">
                            ...
                            <div class="solutions-card__contract_wrapper">
                                <? foreach ($arResult['OFFERS']['ITEMS'] as $offer): ?>
                        ...
                        <div class="blue-button-wrapper">
                            <div class="blue-button location-href-pack" data-link="<?= $arResult['OFFERS']['SRC'] ?>">
                    ...
                    <div class="solutions-card__substrate_bottom">
                        ...
                        <div class="grey-border-button" onclick="location.href='/zayavka/'">
