                        ...
                        <div class="you__reviews_item-top">
                                ...
                                <div class="top_user-avatar">
                                    <picture>
                                        <source type="image/webp"
                                                srcset="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/avatar.webp">
                                        <source type="image/png"
                                                srcset="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/avatar.png">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/avatar.png"
                            ...
                            <svg width="54" height="44" viewBox="0 0 54 44" fill="none"
                                ...
                                <path
                                        ...
                                        stroke="<?= ($item["PROPERTIES"]["R_SOURCE"]["VALUE_ENUM"] == "Vincko") ? "#005DFF" : "#FDE74C" ?>"
                                        stroke-width="4"/>
                            </svg>
                        </span>
                            </div>
                        ...
                        <div class="you__reviews_item-footer">
                            ...
                            <a href="">
                                ...
                                <? if ($item["PROPERTIES"]["R_SOURCE"]["VALUE_ENUM"] == "Vincko"): ?>
                                    ...
                                    <source type="immage/png"
                                            srcset="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/vinco_icon.png">
                                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/vinco_icon.png"
                                         alt="img" loading="lazy">
                                ...
                                <? elseif ($item["PROPERTIES"]["R_SOURCE"]["VALUE_ENUM"] == "Google"): ?>
                                    <source type="immage/webp"
                                            srcset="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/google_icon.webp">
                                    <source type="immage/png"
                                            srcset="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/google_icon.png">
                                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/first__page/you__reviews/google_icon.png"
                                         alt="img" loading="lazy">
                                <? endif; ?>
                                </picture>
                            </a>
