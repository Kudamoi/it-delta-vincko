...
<section class="you__reviews">
    <div class="container">
        ...
        <div class="you__reviews_bottom">
            <p>На Репутационный рейтинг влияют только отзывы клиентов охранных компаний, в том числе - из сторонних источников,
                которые мы тщательно
                собрали для вас, чтобы вы могли принять максимально взвешенное решение.</p>
        </div>
    </div>
</section>