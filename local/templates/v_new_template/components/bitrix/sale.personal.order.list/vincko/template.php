            ...
            <div class="profile__c-main profile__c-main--all-orders show">
                <? if (!empty($arResult["ORDERS"])): ?>
                    ...
                    <? foreach ($arResult["ORDERS"] as $arOrder): ?>
                        <div class="profile__c-main-block profile__c-main-order <?= ($arOrder["PAY"]["PAYED"] == "Y" ? "profile__c-main-order--paid" : "profile__c-main-order--not-paid") ?>">
                            ...
                            <div class="profile__c-main-order-main">
                                    ...
                                    <? foreach ($arOrder["PRODUCT"] as $arProduct): ?>
                                        <div class="profile__c-main-order-main-firm">
                                            <div class="profile__c-main-order-main-firm-name">
                                                <?= $arProduct["POLICY"]["INSURANCE"]["NAME"] . " " . $arProduct["NAME"] ?>
                                            </div>
                                            <a href="<?= $arProduct["URL"] ?>"
                                               class="profile__c-main-order-main-firm-more underline" target="_blank">Подробнее</a>
                                        </div>
                                    <? endforeach; ?>
                                </div>
                                                                ...
                                                                <ul>
                                                                    <? if (!empty($arProduct["COMPANY"]["HONEST"])): ?>
                                                                        <li>
                                                                            ...
                                                                            защитить
                                                                            права и
                                                                            интересы клиентов, заказывающих услуги
                                                                            охранных
                                                                            компаний
                                                                            на
                                                                            платформе vincko:
                                                                    ...
                                                                    <? if (!empty($arProduct["COMPANY"]["CONTRACT"])) : ?>
                                                                        <li>
                                                                            ...
                                                                            индивидуально
                                                                            самой
                                                                            компанией, всю ответственность за условия
                                                                            такого
                                                                            договора
                                                                            несет
                                                ...
                                                <div class="profile__c-main-order-main-info-content">
                                                    ...
                                                    <? if (!empty($arProduct["COMPANY"]["HONEST"])) : ?>
                                                        <a class="blue underline"
                                                           href="<?= $arProduct["COMPANY"]["HONEST"] ?>"
                                                           target="_blank">vincko: Честный
                                                            договор</a>
                                                    <? endif; ?>
                                                    <? if (!empty($arProduct["COMPANY"]["CONTRACT"])) : ?>
                                                        <a class="blue underline"
                                                           href="<?= $arProduct["COMPANY"]["CONTRACT"] ?>"
                                                           target="_blank">Договор охранной
                                                            компании</a>
                                                    <? endif; ?>
                                                </div>
                                ...
                                <div class="profile__c-main-order-main-setter">
                                    <? if (!empty($arOrder["PROPS"]["ADDRESS"]) && ($arOrder["COMPANY_EXISTS"] || $arOrder["EQUIMENT_EXISTS"])): ?>
                                        <p class="grey cmom-title">Адрес доставки</p>
                                        <p class="grey"><?= $arOrder["PROPS"]["ZIP"] . $arOrder["PROPS"]["ADDRESS"] ?></p>
                                    <? endif; ?>
                                    <? if (!empty($arOrder["PROPS"]["COMMENT"])): ?>
                            ...
                            <div class="profile__c-main-order-bottom">
                                <div class="profile__c-main-order-bottom-wrapper">
                                    ...
                                    <? if(!empty($arOrder["PAY"]["CALLBACK"]["sberbank_pokupay"])):?>
                                            ...
                                            <a href="/order/?ORDER_ID=<?= $arOrder["ACCOUNT_NUMBER"] ?>"
                                               ...
                                               class="sberbank-pokupay js-paid">
                                ...
                                <? if ($arOrder["PAY"]["PAYED"] != "Y" && $arOrder["POLICY_EXISTS"]): ?>
