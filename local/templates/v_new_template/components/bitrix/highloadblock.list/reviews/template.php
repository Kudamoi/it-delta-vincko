                        ...
                        <div class="raiting__content">
                            <ul class="raiting__vincko">
                                <li><span class="icon">
                                        ...
                                        </span><span class="text"><?=$row['UF_ALLSCORE_REVIEW_SCORE']?></span>
                                </li>
                                <li><span class="icon">
                                        ...
                                        </span><span class="text"><?=$row['UF_SECURITY_SCORE']?></span>
                                </li>
                                <li><span class="icon">
                                        ...
                                        </span><span class="text"><?=$row['UF_COMFORT_SCORE']?></span>
                                </li>
                                <li><span class="icon">
                                        ...
                                        </span><span class="text"><?=$row['UF_CUSTOMER_FOCUS_SCORE']?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
