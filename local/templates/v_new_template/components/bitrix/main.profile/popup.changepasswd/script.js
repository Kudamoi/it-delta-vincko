		...
		$.ajax({
			...
			success: function (res) {
				if (res.TYPE == 'ERROR') {
					...
					$form.parents(".popup").find(".popup__content").html("<div class='popup__head' style='min-height: 37px;'>"+
						"<div class='popup__title' style='text-align: center'>"+
						res.MESSAGE +
						"</div></div><div class='popup__close'>" +
