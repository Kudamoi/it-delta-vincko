...
<div class="popup popup--new-pass">
	...
	<div class="popup__content">
		...
		<form method="get" action="<?= $arResult["AUTH_URL"] ?>" name="bform" class="popup__form">
		<div class="popup__main">
				...
				<div class="popup__form-title">
					<?=Loc::getMessage("CHANGE_CURRENT") ?>
				</div>
				<div class="pass-wrapper">
					<input type="password" placeholder="<?=Loc::getMessage("CHANGE_CURRENT_PASSWORD") ?>" name="USER_CURRENT_PASSWORD" value="<?=$arResult["USER_CURRENT_PASSWORD"]?>" class="pass-input" />
					<div class="pass__eye">
		...
		<div class="popup__bottom">
			<button class="blue-button" name="change_pwd" value="1">
