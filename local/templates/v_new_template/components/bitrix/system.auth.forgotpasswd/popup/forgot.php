			...
			<div class="popup__main">
				...
				<div class="popup__form js-change-pwd"<?= (!$changePwd ? " style='display:none'" : "") ?>>
					...
					<div class="pass-wrapper">
						<input type="password" data-view="0" name="USER_PASSWORD" minlength="8" class="pass-input-pass"
					...
					<div class="pass-wrapper">
						<input type="password" name="USER_CONFIRM_PASSWORD" value="" data-view="0" minlength="8" class="pass-input-pass" data-field="USER_CONFIRM_PASSWORD"
