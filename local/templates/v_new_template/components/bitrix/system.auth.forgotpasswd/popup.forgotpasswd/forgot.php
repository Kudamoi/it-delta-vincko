...
<div class="popup popup--forget">
	...
	<div class="popup__content">
		...
		<form name="bform" method="post" target="_top" class="js-forgot-form" action="<?= $arResult["AUTH_URL"] ?>">
			...
			<input type="hidden" name="USER_CHECKWORD" value="" disabled>
			...
			<div class="popup__main">
				...
				<div class="popup__form popup__form--phone popup__form-mod--phone">
					...
					<div class="phone-wrapper">
						<input type="tel" placeholder="<?= Loc::getMessage("FORGOT_PHONE_PLACE") ?>"
							   ...
							   name="USER_PHONE_NUMBER" value=""/>
						<div class="info-popup info-popup--unknown" data-field="USER_PHONE_NUMBER">
				...
				<div class="popup__form popup__form--mail popup__form-mod--mail">
					...
					<input
							...
							class="popup__code"
							disabled/>
					<div class="info-popup info-popup--unknown" data-field="USER_CHECKWORD_EMAIL">
						<div class="info-popup__wrapper">
							<div class="info-popup__sign">
								<svg width="18" height="18" viewBox="0 0 18 18" fill="none"
									 xmlns="http://www.w3.org/2000/svg">
				...
				<div class="popup--new-pass" style="display:none"><br/>
					<div class="popup__form">
						...
						<div class="pass-wrapper">
							<input type="password" name="USER_PASSWORD" class="pass-input" disabled
								   placeholder="<?= Loc::getMessage("CHANGE_PASW") ?>"/>
							<div class="pass__eye">
						...
						<div class="pass-wrapper hidden">
							<input type="password" name="USER_CONFIRM_PASSWORD" class="pass-input" disabled
